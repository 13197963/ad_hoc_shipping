...
# Title: shippingUDPTester
# Author: Daniel Osmond
# Generated: Tue Feb 12 13:43:35 2019
##################################################
...
class shippingTester1(gr.top_block, Qt.QWidget):
...
def main(top_block_cls=shippingTester1, options=None):
